...
Reads DATABASE_URL from the environment and swaps the async driver
(asyncpg) for the synchronous driver (psycopg2) since Alembic runs
...
# Override URL from environment (container passes DATABASE_URL)
